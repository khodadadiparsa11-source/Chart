"""The price-agreement check: my number against the number on his screen.

This runs BEFORE anything is built on a symbol, and it stays. The session
report was written, debugged for a night and thrown away because its gold was
the COMEX future -- forty dollars above the spot he trades -- and nothing ever
compared the two. One number, asked on the first day, would have saved it.
